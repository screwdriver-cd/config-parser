    ...
    describe('flatten', () => {
        ...
        describe('templates', () => {
            ...
            beforeEach(() => {
                ...
                templateFactoryMock.getTemplate.withArgs('mynamespace/mytemplate@1.2.3').resolves(namespaceTemplate);
    ...
    describe('functional', () => {
        ...
        it('returns an error if not enough steps', () =>
            parser({
                ...
                assert.match(data.jobs.main[0].commands[0].command, /"jobs.main.steps" must contain at least 1 items/);
            }));
        ...
        it('returns an error if too many environment variables', () =>
            parser({
                ...
                assert.match(data.jobs.main[0].commands[0].command, /"environment" can only have 150 environment/);
            }));
