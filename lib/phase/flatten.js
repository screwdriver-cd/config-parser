...
function merge(newJob, oldJob, fromTemplate) {
    ...
    if (oldJob.blockedBySameJob) {
        newJob.blockedBySameJob = [].concat(oldJob.blockedBySameJob);
    }

    if (oldJob.blockedBySameJobWaitTime) {
        newJob.blockedBySameJobWaitTime = [].concat(oldJob.blockedBySameJobWaitTime);
    }
