 ...
 */
function generateWorkflowGraph(doc, triggerFactory, pipelineId) {
 ...
 * @param  {Promise}
 */
module.exports = (flattenedDoc, buildClusterFactory, triggerFactory, pipelineId) => (
    new Promise((resolve, reject) => {
        ...
        // Workflow graph
        doc.workflowGraph = generateWorkflowGraph(doc, triggerFactory, pipelineId);
